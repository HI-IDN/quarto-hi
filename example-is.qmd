...
::: {.fa-card cols=3}
- palette | **HI sjónarmiðastefna** | Jost leturgerð, litapaletta HÍ frá honnun.hi.is, vatnsmerki í bakgrunni
...
::: {.lean-in}
Skiptu út `presenter-example.jpg` fyrir eigin mynd. Breyttu `partials/contact-card.html` með þínar upplýsingar.
:::
:::
:::
